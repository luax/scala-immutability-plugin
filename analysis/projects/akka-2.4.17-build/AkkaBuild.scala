...
object AkkaBuild extends Build {
  ...
  lazy val defaultSettings = resolverSettings ++
    ...
    Protobuf.settings ++ Seq(
    // compile options
    scalacOptions in Compile ++= Seq("-encoding", "UTF-8", "-target:jvm-1.8", "-feature", "-unchecked", "-Xlog-reflective-calls", "-Xlint", "-Xplugin:../immutability_stats_plugin_assumptions.jar"),
